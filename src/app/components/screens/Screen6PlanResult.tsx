...
// ─── Momento sub-card ─────────────────────────────────────────────────────────
function MomentoCard({ n, title, duracao, children }: {
  n: number; title: string; duracao: string; children: React.ReactNode;
}) {
  return (
    <div style={{
...
// ─── Plan content shared by both tabs ────────────────────────────────────────
function PlanContent({ temaLabel }: { temaLabel: string }) {
  return (
    <>
      <SectionCard title="Tema/Conteúdo de aula" titleSuffix={`(${temaLabel})`}>
      ...
      <SectionCard title="Duração Estimada" titleSuffix="(135 min — 3 aulas de 45 min)">
        <p style={{ margin: "0 0 6px" }}>3 (três) aulas de 45 (quarenta e cinco) minutos.</p>
        <p style={{ margin: 0 }}>A aula será estruturada em momentos estratégicos que permitam uma abordagem completa e interativa — perguntas e respostas, atividades práticas de experimentação e brincadeiras para demonstrar os resultados científicos envolvidos no ciclo da água.</p>
      </SectionCard>
      ...
      <SectionCard title="Aulas e Sequências Didáticas">
        <MomentoCard n={1} title="Introdução e Motivação" duracao="15 minutos">
          <p style={{ margin: "0 0 4px" }}>Inicie a aula perguntando: "Vocês sabem de onde vem a água que bebemos?" Anote as respostas no quadro como ponto de partida para apresentar o ciclo hidrológico.</p>
          <p style={{ margin: 0 }}>Apresente um vídeo curto (5 min) sobre o ciclo da água e discuta brevemente o que foi visto.</p>
        </MomentoCard>

        <MomentoCard n={2} title="Explorando o Ciclo da Água" duracao="30 minutos">
          <p style={{ margin: "0 0 4px" }}>Explique as etapas do ciclo (evaporação, condensação, precipitação, infiltração) com slides e imagens. Incentive a participação com perguntas dirigidas.</p>
          <p style={{ margin: 0 }}>Realize o experimento do "ciclo da água na sacola plástica": os alunos observam a condensação e evaporação ao longo da aula.</p>
        </MomentoCard>

        <MomentoCard n={3} title="Atividade de Ciclo e Mudança Física" duracao="25 minutos">
          <p style={{ margin: 0 }}>Em grupos, cada equipe receberá imagens sobre as mudanças de estado físico da água e deverá montar uma sequência lógica que represente o ciclo hidrológico.</p>
        </MomentoCard>

        <MomentoCard n={4} title="Contextualização e Reflexão" duracao="30 minutos">
          <p style={{ margin: "0 0 4px" }}>Apresente de forma prática a produção de energia elétrica (hidrelétricas) e a importância do ciclo da água.</p>
          <p style={{ margin: 0 }}>Os alunos refletem sobre o impacto das ações humanas (desmatamento, poluição) e discutem soluções possíveis.</p>
        </MomentoCard>

        <MomentoCard n={5} title="Compartilhamento e Avaliação" duracao="30 minutos">
          <p style={{ margin: "0 0 4px" }}>Cada grupo apresenta seu diagrama do ciclo da água com setas indicando as etapas principais.</p>
          <p style={{ margin: 0 }}>Produção textual (mínimo de um parágrafo) sobre a importância do ciclo da água e a conservação dos recursos hídricos.</p>
        </MomentoCard>
      </SectionCard>
...
export function Screen6PlanResult({ onGoTo, planData }: Props) {
  ...
  // "geral" = Plano Geral (Turma) | "adaptacao" = Adaptação
      ...
      <div style={{
        ...
        <div style={{ padding: "28px 36px 60px 36px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 14 }}>
            <div style={{
              background: "#faa01e", borderRadius: 6, height: 24,
          ...
          <div style={{
            ...
            <div style={{ padding: "22px 24px 14px", textAlign: "center" }}>
              <p style={{ fontSize: 18, fontWeight: 600, color: "#0a0a0a", margin: "0 0 3px" }}>Plano de Aula</p>
              <p style={{ fontSize: 13, color: "#666", margin: 0 }}>{ano} do Ensino Fundamental</p>
            </div>

            {/* Tab bar — visual fiel ao Figma */}
            <div style={{
              borderTop: "1px solid #f0f0f0",
              padding: "12px 28px",
              display: "flex", gap: 20, alignItems: "center",
            }}>
              {/* "Plano Geral (Turma)" — borda preta, texto #666; ativo: fundo preto, texto branco */}
              <button
              ...
              {/* "Adaptação" — fundo #00beac, texto branco; inativo: sem fundo */}
              <button
                ...
                style={{
                  ...
                  color: activeTab === "adaptacao" ? "#fff" : "#00beac",
                  transition: "all 0.15s",
                }}
              >
                Adaptação
          ...
          {/* ── Adaptação Ativa card — only on "adaptacao" tab ── */}
          {activeTab === "adaptacao" && (
            <div style={{
              background: "#f0faf9", border: "1px solid #b8f4ee",
              borderRadius: 8, padding: "14px 20px", marginBottom: 12,
              display: "flex", gap: 12, alignItems: "flex-start",
            }}>
              <div style={{
                background: "#63dcd0", borderRadius: 7,
              ...
              <div>
                ...
                <p style={{ fontSize: 12, color: "#334155", margin: "0 0 4px" }}>
                  Este plano foi ajustado para atender ao seguinte perfil:
                </p>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
              {/* Baixar PDF */}
              <button style={{
                background: "#46b2ff", borderRadius: 10, height: 38,
                padding: "0 16px",
                display: "flex", alignItems: "center", justifyContent: "center",
                gap: 7, cursor: "pointer", border: "none",
                fontFamily: "Poppins, sans-serif",
              }}>
                ...
                <span style={{ fontSize: 13, color: "#fff", fontWeight: 500 }}>Baixar PDF</span>
              </button>

              {/* Imprimir */}
              <button style={{
                background: "#fff", borderRadius: 10, height: 38,
                padding: "0 16px",
                display: "flex", alignItems: "center", justifyContent: "center",
                gap: 7, cursor: "pointer", border: "1px solid #666",
                fontFamily: "Poppins, sans-serif",
              }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 16 16" fill="none">
                  <g clipPath="url(#pr)">
            ...
            <button
              onClick={() => onGoTo(5)}
              style={{
                background: "#0032be", borderRadius: 10, height: 38,
                padding: "0 18px",
                display: "flex", alignItems: "center", justifyContent: "center",
                gap: 7, cursor: "pointer", border: "none",
                fontFamily: "Poppins, sans-serif",
          ...
          {/* ── Accordion sections ── */}
          <PlanContent temaLabel={temaLabel} />
