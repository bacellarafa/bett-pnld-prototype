...
export function Screen8ActivityResult({ onGoTo, activityData }: Props) {
    ...
    <div style={{ display: "flex", width: 1440, height: 900, background: "#fff", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ padding: "32px 40px 40px 40px", minHeight: 900 }}>
          ...
          {/* ── Alerta de edição (barra azul inline) — nota 1 · edit_alert_cta_clicked ── */}
          <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
            <div style={{ display: "flex", gap: 12 }}>
              {/* Exportar ▾ — abre modal (export_modal_opened entry=action_bar) */}
              <button
                onClick={() => openExport("action_bar")}
                style={{
                  display: "flex", alignItems: "center", gap: 7,
                  borderRadius: 12, padding: "9px 16px", fontSize: 13,
                  cursor: "pointer", background: ACCENT, border: `1px solid ${ACCENT}`,
